      ...
      for (var i = 1; i < 10; i++) {
        ...
        if (VisaTypeElement !== null) {
          ...
          if (isVisibleVisa) {
            ...
            VisaType.select(1); // 1 corresponds to 'National Visa'
      ...
      for (var i = 1; i < 10; i++) {
        ...
        if (VisaSubTypeElement !== null) {
          ...
          if (isVisibleSubVisa && isOkButtonClicked) {
            ...
            VisaSubType.select(2); // 2 corresponds to 'Family Reunification'
      ...
      for (var i = 1; i < 10; i++) {
        ...
        if (VisaSubTypeElement !== null) {
          ...
          if (isVisibleSubVisa && isOkButtonClicked) {
            console.log("VisaSubType " + i + " is visible");
            var VisaSubType = $("#VisaSubType" + i).data("kendoDropDownList");
            VisaSubType.select(3); // 3 corresponds to 'Family Reunification'
            VisaSubType.trigger("change");
          } else {
            // console.log("VisaType " + i + " is not visible");
          }
...
async function RemplirMission() {
  ...
  setTimeout(function () {
    ...
    console.log("تم تنفيذ الشيفرة لزر Casa Regroupement Premium بنجاح!");
  });
    
  const CasaEtudeNormalButton = createButton("Casa Etude Normal", function() {
(function () {
    "use strict";
      ...
      for (var i = 1; i < 10; i++) {
        ...
        if (VisaSubTypeElement !== null) {
          ...
          if (isVisibleSubVisa && isOkButtonClicked) {
            console.log("VisaSubType " + i + " is visible");
            var VisaSubType = $("#VisaSubType" + i).data("kendoDropDownList");
            VisaSubType.select(1); // 1 corresponds to 'Student Visa'
            VisaSubType.trigger("change");
          } else {
            // console.log("VisaType " + i + " is not visible");
          }
  ...
  setTimeout(function () {
    ...
    console.log("تم تنفيذ الشيفرة لزر Casa Etude Normal بنجاح!");
  });
  const CasaEtudePremiumButton = createButton("Casa Etude Premium", function() {
(function () {
    "use strict";
      ...
      for (var i = 1; i < 10; i++) {
        ...
        if (locationElement !== null) {
          ...
          if (isVisibleLocation) {
            console.log("Location " + i + " is visible");
            var Location = $("#Location" + i).data("kendoDropDownList");
            Location.select(6); // 6  'Casablanca'
            Location.trigger("change");
          } else {
            // console.log("Element " + i + " is not visible");
          }
  ...
  setTimeout(function () {
    ...
    console.log("تم تنفيذ الشيفرة لزر Casa Etude Premium بنجاح!");
  });

  const CasaWorkNormalButton = createButton("Casa Work Normal", function() {
(function () {
    "use strict";
      ...
      for (var i = 1; i < 10; i++) {
        ...
        if (VisaSubTypeElement !== null) {
          ...
          if (isVisibleSubVisa && isOkButtonClicked) {
            console.log("VisaSubType " + i + " is visible");
            var VisaSubType = $("#VisaSubType" + i).data("kendoDropDownList");
            VisaSubType.select(4); // 4 corresponds to 'Work Visa'
            VisaSubType.trigger("change");
          } else {
            // console.log("VisaType " + i + " is not visible");
          }
  ...
  const CasaWorkPremiumButton = createButton("Casa Work Premium", function() {
(function () {
    "use strict";
...
if (targetSibling) {
 ...
 const row1 = document.createElement('div');
  ...
  row1.appendChild(CasaregrNormalButton);
  row1.appendChild(CasaEtudeNormalButton);
  row1.appendChild(CasaWorkNormalButton);
    
  const row2 = document.createElement('div');
  row2.style.display = 'flex';
  row2.appendChild(CasaregrPremiumButton);
  row2.appendChild(CasaEtudePremiumButton);
  row2.appendChild(CasaWorkPremiumButton); 
